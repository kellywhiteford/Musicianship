function [subject] = NewSubject_HINT_Practice(ID,parameters,uni)
% This function is called by SpeechTest for the experiment "HINT_Practice" 
% if the given subject ID and university ID  does not yet exist. It creats 
% a "subject" structure to track a subject's responses and progress.
...
subject.listord = 26; % hard coded so that only list 26 is used
...
save([cd '\Output\HINT_Practice_' ID '_' uni '.mat'],'subject');
