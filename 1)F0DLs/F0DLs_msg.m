...
msg.ready_msg    = {'Which sequence was changing?'};
msg.start_msg    = {'You will hear two sequences of tones. Your task is to determine whether the 1st or 2nd sequence is changing.', ...
