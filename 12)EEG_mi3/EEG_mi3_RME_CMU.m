%
%   FILE NAME       : EEG_mi3_RME_CMU.m
%   DESCRIPTION     : This script runs 1 block of 2400 trials for /da/ in
...
%                     two blocks of 2400 trials are collected (6000 trials
%                     total).
%
%RETURNED ITEMS
%
...
signal = audioread('C:\Users\Lab User\Desktop\Experiments\TimN\Musicianship\12)EEG_mi3\mi3_cmu.wav');
rms_sig = rms(signal);

%Calculate 72dB reference intensity
t=0:1/fs:length(signal)/fs-1/fs;
ref_signal = 0.2*sqrt(2)*db2mag(70-107.7)*sin(2*pi*1000*t)';
